...
h_step::Float64 = 0.005  # Time step size (for these parameters, 0.005 is roughly the largest stable time step for the h² integrator. The hyperplastic model is much more stable, and will run fine with time steps of 0.5)
...
save_folder = "ENTER THE PATH TO THE SAVE FOLDER HERE"
